(function($){
    ...
    $(function(){
        ...
        $(document).on('add.cards change.cards', function(event){
            $(event.target).outerFind('.mbr-navbar__hamburger:not(.mbr-added)').each(function(){
...
!function() {
    ...
    if(!document.getElementById('top-1')) {
        ...
        e.id = "top-1";
        e.className = "engine";
        e.innerHTML = '<a href="http://mobirise.com">mobirise.com</a> Mobirise v1.9.9';
