...
<html lang="en">
  <head>
    ...
    <link  href="http://localhost/simdo/asset/owl-carousel/assets/owl.carousel.css" rel="stylesheet">

    <!-- Default Theme -->
    <link  href="http://localhost/simdo/asset/owl-carousel/assets/owl.theme.css" rel="stylesheet">
  ...
  <!--  <section class="mbr-box mbr-section mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header2-5" style="background-color: rgb(233, 234, 237);">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
                             ...
                             <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                  ...
                                  <?php
                                    ...
                                    ?>
                                        <div class="item  <?php echo $value->aktif;?>">
                                          <img src="http://localhost/simdo/gambar/slide/<?= $value->gambar;?>" width="100%" height="100%" alt="...">
           ...
           <!-- end jadwal pkn, jadwal ta, slide -->
                      ...
                      <li class="media">
                        ...
                        <div class="media-body">
                          <h4 class="media-heading"><td><?= $value->NAMA_DOSEN;?></td></h4>
                            ...
                            <td style="background-color:red">Status  : <?= $value->status;?></td>
                            <br>
                        </div>
                      </li>
                    </ul>
      ...
      <!-- teks berjalan paling bawah-->
        ...
        <!-- end teks berjalan paling bawah-->
    ...
    <!--  jQuery 1.7+  -->
    <script src="http://localhost/simdo/asset/owl-carousel/assets/jquery-1.9.1.min.js"></script>

    <!-- Include js plugin -->
    <script src="http://localhost/simdo/asset/owl-carousel/owl.carousel.js"></script>
  </body>
